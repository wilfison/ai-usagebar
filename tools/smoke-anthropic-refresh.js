// End-to-end smoke for lib/oauth/anthropic.js. Reads ~/.claude/.credentials.json
// (or --path X), reports plan + countdown + needsRefresh, and on --force runs a
// real refresh + writeBack so sibling keys (mcpOAuth, etc.) can be confirmed
// preserved with `jq 'keys'` before/after.
//
