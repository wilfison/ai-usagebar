 ...
 * displayable error (`code === 0` means transport/schema and is not shown). The
 * server-provided `body` is foreign text and is not translated; only the `HTTP
 * <code>` status label routes through the injected translator.
