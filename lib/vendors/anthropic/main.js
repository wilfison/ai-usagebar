...
// The usage endpoint 429s hard without a Claude Code User-Agent; the exact patch
// version isn't validated, so a stable recent claude-code/<version> is fine.
export const USAGE_USER_AGENT = 'claude-code/2.1.183';
