 ...
 *
 * This module imports `gi://GLib` (for `GLib.getenv`) and pulls in the per-vendor
 * orchestrators (which transitively import `Gio`); it is therefore not a pure
 * module and has no unit test — the logic it wires is covered by the pure-module
 * suites.
 */
...
const anthropicAdapter = {
    ...
    buildSection: anthropicBuildSection,
};
...
const openaiAdapter = {
    ...
    buildSection: openaiBuildSection,
};
...
const openrouterAdapter = {
    ...
    buildSection: openrouterBuildSection,
};
...
const deepseekAdapter = {
    ...
    buildSection: deepseekBuildSection,
};
