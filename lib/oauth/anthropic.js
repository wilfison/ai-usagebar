...
// Atomically replace the credentials file with a document containing the
// new tokens and every unknown top-level key the original file had
// (mcpOAuth, etc.). The Claude CLI writes the same file; silently losing
// those keys would break MCP integrations. Never throws — IO failures
// surface as {ok: false, kind: 'io', message}.
